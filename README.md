...
**[📚 View Documentation](https://dmi-palette.readthedocs.io/)** | **[🐛 Report a Bug](https://github.com/56kyle/dmi-palette/issues)** | **[✨ Request a Feature](https://github.com/56kyle/dmi-palette/issues)**

---

## Installation

You can install `dmi_palette` via [pip](pip-documentation) from PyPI:

```bash
pip install dmi_palette
```

### Installation for Development

To set up `dmi_palette` for local development:

1.  Clone the repository:
    ```bash
    git clone https://github.com/56kyle/dmi-palette.git
    cd dmi-palette
    ```
...
# from dmi_palette import some_function
...
# dmi-palette --help
# dmi-palette do-something --input file.txt
```
...
Report bugs or suggest features via the [issue tracker](https://github.com/56kyle/dmi-palette/issues).
...
[documentation]: https://dmi-palette.readthedocs.io/
